...
__DEFINE__(1665507677737, function(require, module, exports) {
module.exports = {
  HYEventBus: require('./event-bus'),
  HYEventStore: require('./event-store')
}

}, function(modId) {var map = {"./event-bus":1665507677738,"./event-store":1665507677739}; return __REQUIRE__(map[modId], modId); })
__DEFINE__(1665507677738, function(require, module, exports) {
class HYEventBus {
  constructor() {
    this.eventBus = {}
  }
...
__DEFINE__(1665507677739, function(require, module, exports) {
...
}, function(modId) { var map = {"./event-bus":1665507677738,"./utils":1665507677740}; return __REQUIRE__(map[modId], modId); })
__DEFINE__(1665507677740, function(require, module, exports) {
...
return __REQUIRE__(1665507677737);
})()
